...
import ro.ldir.android.remote.IBackendGarbageList;
 ...
 *
 *
 *  Filename: GarbageList.java
 *  Author(s): Catalin Mincu, cata.mincu@gmail.com
 *
 */

public class GarbageList implements IBackendGarbageList {
	LinkedList<Garbage> garbage = new LinkedList<Garbage>();
