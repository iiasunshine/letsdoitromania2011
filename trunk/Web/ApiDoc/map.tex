...
\subsection{Obtaining the garbage tags in a bounding box (entities)}

\apilocation{get}{map/ws/garbageList/?topLeftX=\param{topLeftX}\&\\topLeftY=\param{topLeftY}\&bottomRightX=\param{bottomRightX}\&bottomRightY=\param{bottomRightY}\&\\maxResults=\param{maxResults}}
\begin{apidata}{parameters}
  \begin{datalist}
...
\begin{apidata}{returns}
  \begin{datalist}
    \replyditem{A XML/JSON of all the garbages in the bounding box,
    according to the ``Accept'' headers specified by the calling client.}
