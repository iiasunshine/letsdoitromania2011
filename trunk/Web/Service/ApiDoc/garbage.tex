...
array. The array length can be obtained through the \texttt{pictureCount} field
of the \texttt{garbage} entity.  To make any of the following calls, a valid
image index must be known. Valid indexes are from 0 to \texttt{pictureCount} -
1.
