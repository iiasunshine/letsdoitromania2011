...
public class ConnectionUtils {
	...
	public static final String ACTION_GET_GARBAGE_IN_AREA = "map/ws/garbageList/%s";
	...
	/**
	 * Creates an URL like:
	 * http://app.letsdoitromania.ro:8080/LDIRBackend/<b>action</b>
	 * 
	 * @param action
	 * @return
	 */
	public static final String getWsAddress(String action, Object... params) {
		String url = _ldir_proto + "://" + _ldir_host + ":" + _ldir_port + "/"
				+ _ldir_ws_auth + "/" + String.format(action, params);
	...
	public static DefaultHttpClient getHttpConn(String user, String password) {
		...
		CredentialsProvider cp = ((AbstractHttpClient) httpClient)
