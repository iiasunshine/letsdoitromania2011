			...
			<div id="content">
				...
				<div id="leftColumn">
					...
					<h:panelGroup
						...
						<strong><h:outputText
								value="#{mormanManager.myGarbage.garbage.chartedArea.name}" /></strong>
						<br />
						<br />
						<h:outputText escape="false" value="#{msg.details_county} " />
						<strong><h:outputText
								value="#{mormanManager.myGarbage.garbage.county.name}" /></strong>
						<br />
						<br />
						<h3>
						...
						<strong><h:outputText
								value="#{mormanManager.myGarbage.garbage.status}" /></strong>
						<br />
						<br />
						<h:outputText escape="false"
						...
						<h3>
							<h:outputLink
								value="cartare-mormane-editare.jsf?garbageId=#{mormanManager.myGarbage.garbage.garbageId}">
				...
				<div id="rightColumn">
					<a4j:form>
						<m:map latitude="#{mormanManager.myGarbage.coordYToString}"
							...
							width="710px" height="600px" zoom="9" jsVariable="myMap">
							...
							<a4j:repeat value="#{mormanManager.myGarbageList}" var="gunoi">
								<m:marker latitude="#{gunoi.coordYToString}"
									...
									<m:icon
										imageURL="http://app.letsdoitromania.ro:8080/icons/morman-rosu-20x20.png"
										width="20" height="20" />
							...
							<m:marker latitude="#{mormanManager.myGarbage.coordYToString}"
								...
								showInformationEvent="mouseover">
								<m:icon
									imageURL="http://app.letsdoitromania.ro:8080/icons/morman-galben-20x20.png"
									width="20" height="20" />
								<m:htmlInformationWindow
									htmlText="<strong>Morman curent (#{mormanManager.myGarbage.idToString})</strong><br/>#{msg.details_area} #{mormanManager.myGarbage.garbage.chartedArea.name} <br/>#{msg.details_county} #{mormanManager.myGarbage.garbage.county.name} <br/>" />
							</m:marker>
						</m:map>
					</a4j:form>
				</div>
