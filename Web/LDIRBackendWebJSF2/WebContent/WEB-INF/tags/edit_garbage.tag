		...
		<div id="rightColumn">
			...
			<h:form styleClass="form" id="form" enctype="multipart/form-data">
				...
				<c:if test="${(role eq 'ORGANIZER')or (role eq 'ORGANIZER_MULTI')}">
					...
					<div class="label">
						<h:outputText value="#{msg.chart_add_nominate}" />
					</div>
					<h:selectBooleanCheckbox
						value="#{mormanManager.myGarbage.garbage.toVote}"
						styleClass="formDate" id="toVote" />
					<br />
					<div class="label">
						<h:outputText value="#{msg.chart_add_toclean}" />
					</div>
					<h:selectBooleanCheckbox
						value="#{mormanManager.myGarbage.garbage.toClean}"
						styleClass="formDate" id="toClean" />
					<br />
					<br />
				</c:if>
