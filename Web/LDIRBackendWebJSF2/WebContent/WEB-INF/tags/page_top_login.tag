...
<div id="headerContainer">
	<div id="header">
		<div id="logo">
			<a href="http://www.letsdoitromania.ro"><img
				src="${pageContext.servletContext.contextPath}/layout/images/logo.jpg"
				width="200" height="90" /></a>
		</div>
		<div id="topAdvertisement">
			<a href="${pageContext.servletContext.contextPath}/home.jsf"><img
				src="${pageContext.servletContext.contextPath}/layout/images/banner_leaderboard_728x90px.gif"
				width="728" height="90" /></a>
		</div>
		<div id="topMenu">
			<ul>
				<li><a
					href="${pageContext.servletContext.contextPath}/home.jsf"
				...
				<li><a
					href="${pageContext.servletContext.contextPath}/users/cartare-mormane-lista.jsf"
					class="${selected eq 'mormane' ? 'active' : ''}"><span>${msg.meniu_cartare_mormane}</span></a></li>
				<c:if test="${not (role eq 'VOLUNTEER')}">
					<li><a
						href="${pageContext.servletContext.contextPath}/admin/admin-lista-voluntari.jsf"
						class="${selected eq 'lista_utilizatori' ? 'active' : ''}"><span>${msg.meniu_lista_utilizatori}</span></a></li>
					<li><a
						href="${pageContext.servletContext.contextPath}/admin/admin-lista-mormane.jsf"
						class="${selected eq 'lista_mormane' ? 'active' : ''}"><span>${msg.meniu_lista_mormane}</span></a></li>
				</c:if>
				...
				<c:if
					test="${(role eq 'ADMIN') or (role eq 'ORGANIZER') or (role eq 'VOLUNTEER')}">
					<li><a
						href="${pageContext.servletContext.contextPath}/users/echipa-vizualizare.jsf"
						class="${selected eq 'echipa_edit' ? 'active': ''}"><span>${msg.meniu_echipa_edit}</span></a></li>
				</c:if>
