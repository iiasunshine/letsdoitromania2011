 	...
 	<h:messages warnClass="registerMessageError" infoClass="registerMessageOk" />
 					<h:form>
                        ...
                        <h:inputText value="#{orgBean.teamName}" id="code" styleClass="formTextfield"/>
 				              ...
 				              <h3>
                            	<h:outputText value="S-au gasit urmatoarele echipe care sa contina textul: '#{orgBean.teamName}'"/>
                              </h3>	
                            	<br/>
                            	 <a4j:repeat value="#{orgBean.teamAvalable}" var="team">
                          		...
                          		<h3>
                          			<h:outputText value="Alegeti numele exact al echipei din aceasta lista."/>
                          		</h3>
                            </h:panelGroup>
