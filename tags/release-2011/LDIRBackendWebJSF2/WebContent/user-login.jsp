                    ...
                    <div id="content">
                        <div id="leftColumn">
                            ...
                            <h:form styleClass="form">
                                <div class="labelLeft"><h:outputText value="#{msg.login_mail}"/></div>
                                <!--input id="email" type="text" name="j_username" class="formTextfieldLeft"/-->
                                <h:inputText value="#{loginBean.loginMail}"
                                             id="email"
                                             styleClass="formTextfieldLeft"/>
                                <br />
                                <div class="labelLeft"><h:outputText value="#{msg.login_passowrd}"/></div>
                            ...
                            <br/>
                            <h3>
                                <h:outputLink value="reset-password.jsf"><h:outputText value="#{msg.reset_link}" escape="false"/></h:outputLink>
                            </h3>
                        </div>
